...
function StandOut() {
  return (
    <div className='StandOut-Container'>
      <h1 className='Heading'>Why Pick Blue Monkeys Woodworking?</h1>
      <div className='StandOut-Cards'>
        ...
        <div className='StandOut-Card'>
          <h1>3D Renderings</h1>
          <p>Durning the design phase we will work hand and hand with you to create your dream piece of furniture, We design 3D renderings to help you visualize your idea and to make sure you get the perfect piece of furniture for your home every time.</p>
        </div>
